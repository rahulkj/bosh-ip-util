...
func testAvailableIPs(t *testing.T, when spec.G, it spec.S) {
	...
	when("compute", func() {
		it("reports a json string with all the details", func() {
			...
			Expect(results.Result[0].TotalIPs).To(Equal(62))
			...
			Expect(results.Result[0].TotalAvailableIPs).To(Equal(51))
			...
			Expect(results.Result[1].TotalIPs).To(Equal(510))
			...
			Expect(results.Result[1].TotalAvailableIPs).To(Equal(499))
			...
			Expect(results.Result[2].TotalIPs).To(Equal(510))
			...
			Expect(results.Result[2].TotalAvailableIPs).To(Equal(476))
			...
			Expect(results.Result[3].TotalIPs).To(Equal(510))
			...
			Expect(results.Result[3].TotalAvailableIPs).To(Equal(244))
		})
	})
	...
	when("compute", func() {
		it("reports a json string with all the details", func() {
			...
			Expect(results.Result[0].TotalIPs).To(Equal(254))
			Expect(results.Result[0].TotalReservedIPs).To(Equal(137))
			Expect(results.Result[0].TotalAvailableIPs).To(Equal(86))
			...
			Expect(results.Result[3].TotalIPs).To(Equal(254))
			Expect(results.Result[3].TotalReservedIPs).To(Equal(184))
			Expect(results.Result[3].TotalAvailableIPs).To(Equal(70))
			...
			Expect(results.Result[6].CIDR).To(Equal("10.135.132.0/22"))
			Expect(results.Result[6].TotalIPs).To(Equal(1022))
			Expect(results.Result[6].TotalReservedIPs).To(Equal(777))
			Expect(results.Result[6].TotalAvailableIPs).To(Equal(245))
			Expect(results.Result[6].SubnetName).To(Equal("XY13711_HAT_10.135.132.0_22_v7"))
			...
			Expect(results.Result[9].TotalIPs).To(Equal(254))
			Expect(results.Result[9].TotalReservedIPs).To(Equal(235))
			Expect(results.Result[9].TotalAvailableIPs).To(Equal(19))
